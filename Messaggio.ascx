<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="Messaggio.ascx.vb" Inherits="JazzHub_Web.Messaggio" %>

<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>

<script type="text/javascript">

    function openMessaggio(key, nome, mail) {
        $('#<%=txt_destinatario.ClientId%>').val('(' + nome + ') ' + mail);
        PageMethods.SalvaDestinatarioMessaggio(key, utenteSaved, PMFailure);
    }
    function utenteSaved() {
        openModal('#myModalMail');
    }
                                    ...
                                    <div class="form-vertical">
                                        <div class="row">
                                            <div class="form-group">
                                                <label for="to" class="">
                                                    Destinatario:</label>
                                                <asp:TextBox ID="txt_destinatario" MaxLength="256" name="mail_dest" runat="server"
