                            ...
                            <div id="register-form" name="register-form" class="nobottommargin">
                                <div class="tab-content clearfix" id="tab-principale">
                                    <div class="panel panel-default nobottommargin" id="div_dati_01" runat="server">
                                        <div class="panel-body" style="padding: 40px;">
                                            ...
                                            <div class="col_full" id="div_ragione_sociale" runat="server">
                                ...
                                <div class="tab-content clearfix" id="tab-fatturazione">
                                    <div class="panel panel-default nobottommargin" id="div_dati_02" runat="server">
                                        <div class="panel-body" style="padding: 40px;">
                                            <div class="col_half" id="div_codice_fiscale" runat="server">
                                                <cc:rTextBox ID="txt_codice_fiscale" name="txt_codice_fiscale" runat="server" MaxLength="16" CssClass="form-control"
                                                     Form_Vertical="true" />
                                            </div>
                                            <div class="col_half col_last" id="div_partita_iva" runat="server">
                                            ...
                                            <div class="col_two_third col_last" id="div_localita" runat="server">
                                                <cc:rTextBox ID="txt_localita" runat="server" MaxLength="128" CssClass="form-control"
                                                     Form_Vertical="true" />
                                            </div>
                                            <div class="col_two_third col_last" id="div_stato_estero" runat="server">
                                            ...
                                            <div class="col_full nobottommargin">
                                                <div class="col_half nobottommargin text-lg-left text-md-left text-sm-left  text-xs-center">
                                                ...
                                                <div class="col_half nobottommargin col_last text-lg-right text-md-right text-sm-right  text-xs-center">
