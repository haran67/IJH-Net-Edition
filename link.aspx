...
<asp:Content ID="Content3" ContentPlaceHolderID="content" runat="server">
    <div class="content-wrap nopadding">
        <div class="row common-height clearfix">
            <div class="col-sm-5 col-padding dark" style="background: #333 url('images/custom/') center center no-repeat; background-size: cover;">
            ...
            <div class="col-sm-7 col-padding">
                <div class="row clearfix">
                    <h3 class="nomargin" style="font-weight: normal">
                        <a href="http://www.carpooling.it/"><i class="icon-line-link"></i> Car Pooling</a>
                    </h3>
                </div>
            </div>
        </div>
        <div class="row common-height alt clearfix">
            ...
            <div class="col-sm-7 col-padding">
                <div class="row clearfix">
                    <h3 class="nomargin" style="font-weight: normal">
                        <a href="http://www.emule.com/it/"><i class="icon-line-link"></i> Emule</a>
                    </h3>
                    <div class="divider divider-left nomargin" style="height: 20px;"></div>
                    <h3 class="nomargin" style="font-weight: normal">
                        <a href="https://www.utorrent.com/intl/it/"><i class="icon-line-link"></i> uTorrent</a>
                    </h3>
                </div>
            </div>
        </div>
        <div class="row common-height clearfix">
            ...
            <div class="col-sm-7 col-padding">
                <div class="row clearfix">
                    <h3 class="nomargin" style="font-weight: normal">
                        <a href="http://www.jazzit.it"><i class="icon-line-link"></i> Jazzit Fest</a>
                    </h3>
                    <div class="divider divider-left nomargin" style="height: 20px;"></div>
                    <h3 class="nomargin" style="font-weight: normal">
                        <a href="http://www.milkstudios.it/"><i class="icon-line-link"></i> Milk Studio</a>
                    </h3>
                    <div class="divider divider-left nomargin" style="height: 20px;"></div>
                    <h3 class="nomargin" style="font-weight: normal">
                        <a href="http://www.musicisti-jazz.it/"><i class="icon-line-link"></i> Musicisti italiani di Jazz</a>
                    </h3>
                </div>
            </div>
        </div>
