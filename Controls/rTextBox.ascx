<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="rTextBox.ascx.vb" Inherits="JazzHub_Web.rTextBox" %>
    ...
    <div class="col-md-9" id="div_col" runat="server">
        <div class="input-group" id="div_input" runat="server" style="width:100%">
            ...
            <span class="input-group-btn" id="span_button" runat="server" visible="false">
                <asp:LinkButton ID="btn_action" runat="server" CssClass="btn btn-JazzHub btn-outline" style="margin-left:0px;">
                    <i class="fa fa-arrow-left fa-fw" id="i_action" runat="server"></i><asp:Literal ID="ltl_action" runat="server"></asp:Literal>
                </asp:LinkButton>
		    </span>
        </div>
