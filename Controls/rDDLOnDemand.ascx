<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="rDDLOnDemand.ascx.vb" Inherits="JazzHub_Web.rDDLOnDemand" %>

<div class="form-group" id="div_form" runat="server">
    <label class="control-label col-md-3" style="white-space:nowrap;">
