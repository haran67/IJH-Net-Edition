<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Jazz.Master" CodeBehind="Wip.aspx.vb" Inherits="JazzHub_Web.Wip" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="container vertical-middle center clearfix text-uppercase text-shadow">
        ...
        <h1>Partners</h1>
        <h3>Jazz Hub ha attivato una lunga serie di collaborazioni per promuovere la propria attività. </h3>
